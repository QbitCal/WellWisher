 ...
 * @version 10/17/2021
 */
public class AddPhysicalActivity extends javax.swing.JFrame {

    /**
     * Creates new form AddActivity
     */
    public AddPhysicalActivity() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddPhysicalActivity.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddPhysicalActivity().setVisible(true);
            }
        });
    }
