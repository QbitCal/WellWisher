 ...
 * @version 10/17/2021
 */
public class AddDetailPhysicalActivity extends javax.swing.JFrame {

    /**
     * Creates new form AddActivity
     */
    public AddDetailPhysicalActivity() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Low", "Moderate", "High" }));
        ...
        jLabel9.setText("Add A New Physical Activity Entry");
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        try {
            ...
            PhysicalActivity act = Controller.validatePhysicalActivity(
            ...
            jLabel8.setText("Entry successfully added!");
            Controller.sortActivityLog();
            Controller.showActivityListUI();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddDetailPhysicalActivity.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddDetailPhysicalActivity().setVisible(true);
            }
        });
    }
